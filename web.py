...
def change_tts_inference(bert_path,cnhubert_base_path,gpu_number,gpt_path,sovits_path, batched_infer_enabled):
    print('change_tts_inference tick')
...
# global bert_pretrained_dir,cnhubert_base_dir,gpu_number_1C,GPT_dropdown,SoVITS_dropdown, batched_infer_enabled
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            ...
            with gr.TabItem(i18n("1C-推理")):
                ...
                with gr.Row():
                    ...
                    with gr.Row():
                        debug_tts = gr.Button(value=i18n("开启TTS推理WebUI"),variant='primary',visible=True)
...
def start_sub_tts_inference(bert_path,cnhubert_base_path,gpu_number,gpt_path,sovits_path, batched_infer_enabled):
    # print(bert_path,cnhubert_base_path,gpu_number,gpt_path,sovits_path, batched_infer_enabled)
    print('start_sub_tts_inference tick')
    ...
    # os.environ["is_share"]=str(is_share)
    print(cmd)
    sub_tts_inference = Popen(cmd, shell=True)
    return sub_tts_inference


# 启动后台任务
# background_process = change_tts_inference(bert_pretrained_dir,cnhubert_base_dir,gpu_number_1C,GPT_dropdown,SoVITS_dropdown, batched_infer_enabled)
batched_infer_enabled = False
sub_tts_inference = start_sub_tts_inference(bert_pretrained_dir,cnhubert_base_dir,gpu_number_1C,GPT_dropdown,SoVITS_dropdown, batched_infer_enabled)
